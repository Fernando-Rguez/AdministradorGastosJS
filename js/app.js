...
class UI {
    ...
    imprimirAlerta(mensaje, tipo) {
        ...
        divMesaje.classList.add('text-center', 'alert');
    ...
    mostrarGastos( gastos) {
        ...
        gastos.forEach( gasto => {
            ...
            // nuevoGasto.setAttribute('data-id', id);//Lo mismo que lo de abajo pero más viejo
    ...
    comporobarPresupuesto(presuestoObj) {
        const { presupuesto, restante } = presuestoObj;
...
function agregarGasto(e) {
    ...
    ui.comporobarPresupuesto(presupuesto);
